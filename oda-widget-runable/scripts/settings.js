...
const initSdk = (name) => {
    ...
    setTimeout(() => {
        ...
        let chatWidgetSettings = {
            URI: '<CHANGE_ME_ODA_URI>',                 // ODA URI, only the hostname part should be passed, without the https://
            clientAuthEnabled: isClientAuthEnabled,     // Enables client auth enabled mode of connection if set true
            channelId: '<CHANGE_ME_CHANNEL_ID>',        // Channel ID, available in channel settings in ODA UI
